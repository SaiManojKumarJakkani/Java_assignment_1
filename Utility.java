...
class CSV{
    ...
    public void addRecord(String countryName,String temperature ) {
        ...
        try{Float.parseFloat(temperature);}
        catch(Exception e)
        {
    ...
    public  void  editRecord(int index,  int option, String value) {
        if(option==2){
            try{Float.parseFloat(value);}
                ...
                System.out.println("Please enter valid temperature value");
                return;}
        ...
        while(true){
            ...
            try{
                ...
                if ("sort".equalsIgnoreCase(operation)) {
                    Collections.sort(csv_file.data, (a, b) -> a[0].compareToIgnoreCase(b[0]));
                    ...
                    while(true) {
                        try {
                            ...
                            if(index<=-1 || index>=csv_file.data.size()){
