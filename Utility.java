...
class CSV{
    ...
    public void addRecord(String countryName,String temperature ) {
        ...
        if(countryName=="" || (temperature=="")){
            System.out.println("Null values are not accepted. Please try again");
            return;
        }
        try{Integer.parseInt(temperature);}
        catch(Exception e){ System.out.println("Please enter numeric values for temperature. Please try again");}
        boolean found = false;
        for (String[] record : data) {
    ...
    public  void  editRecord(int index,  String option, String value) {
